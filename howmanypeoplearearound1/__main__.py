...
from howmanypeoplearearound1.oui import oui
from howmanypeoplearearound1.analysis import analyze_file
if os.name != 'nt':
...
def main(adapter, scantime, verbose, number, nearby, jsonprint, out, allmacaddresses, nocorrection, loop, analyze, sort):
    if analyze != '':
